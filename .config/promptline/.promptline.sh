...
function __promptline_left_prompt {
  ...
  # section "a" header
  slice_prefix="${a_bg}${alt_sep}${a_fg}${a_bg}${space}" slice_suffix="$space${a_sep_fg}" slice_joiner="${a_fg}${a_bg}${alt_sep}${space}" slice_empty_prefix="${a_fg}${a_bg}${space}"
  [ $is_prompt_empty -eq 1 ] && slice_prefix="$slice_empty_prefix"
  # section "a" slices
  __promptline_wrapper "$(__promptline_host)" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; is_prompt_empty=0; }
...
function __promptline {
  ...
  local c_fg="${wrap}38;5;249${end_wrap}"
  local c_bg="${wrap}48;5;238${end_wrap}"
  local c_sep_fg="${wrap}38;5;238${end_wrap}"
  local warn_fg="${wrap}38;5;15${end_wrap}"
  local warn_bg="${wrap}48;5;124${end_wrap}"
  local warn_sep_fg="${wrap}38;5;124${end_wrap}"
